...
function App() {
  ...
  async function answer(option: string) {
    ...
    try {
      ...
      else { const completed = await api<Result>(`/api/v1/sessions/${sessionId}/complete`, { method: "POST" }); setResult(completed); setScreen("result"); }
